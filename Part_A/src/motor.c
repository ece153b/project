...
#define DELAY 10000	// delay between steps of the sequences - got this from Lab 2, remove if not needed 
...
void setDire(int8_t direction) { //0 is counterclockwise, 1 is clockwise
	dire = direction; 
}
